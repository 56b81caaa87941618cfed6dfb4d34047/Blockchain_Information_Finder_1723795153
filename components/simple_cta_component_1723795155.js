...
*/
Vue.component("simple_cta_component_1723795155", {
    template: `
        ...
        <div id="cta-inner-container" class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-white md:text-lg">Stay ahead of the curve with real-time updates on emerging blockchain technologies, projects, and trends.</p>
                </div>
